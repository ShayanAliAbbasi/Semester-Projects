...
namespace Shingine {
    ...
    IGameScreen* Shingine::ScreenList::moveNext() {
    ...
    IGameScreen* Shingine::ScreenList::movePrevious() {
        IGameScreen* currentScreen = getCurrent();
    ...
    void Shingine::ScreenList::setScreen(int nextScreen) {
        m_currentScreenIndex = nextScreen;
    }

    void Shingine::ScreenList::addScreen(IGameScreen* newScreen) {
    ...
    void Shingine::ScreenList::destroy() {
